...
export default async function Page() {
  ...
  return (
    <div>
      <div className="sm:grid sm:grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="sm:grid sm:grid-cols-5 flex flex-col-reverse w-full gap-x-24  mt-20">
        <div className="relative aspect-square col-span-2 mt-10">
          <Image
            src="/about-2.jpg"
            fill
      ...
      <div className=" sm:text-end text-center mt-8 mb-2">
        <a
          href="/cabins"
